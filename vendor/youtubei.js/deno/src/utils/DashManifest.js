...
async function OTFPostLiveDvrSegmentInfo({ info }) {
  ...
  return /* @__PURE__ */ DashUtils.createElement(
    ...
    /* @__PURE__ */ DashUtils.createElement("segmentTimeline", null, template.timeline.map((segment_duration) => /* @__PURE__ */ DashUtils.createElement(
      "s",
      {
...
function SegmentInfo({ info }) {
  if (info.is_oft || info.is_post_live_dvr) {
    return /* @__PURE__ */ DashUtils.createElement(OTFPostLiveDvrSegmentInfo, { info });
  }
  return /* @__PURE__ */ DashUtils.createElement(DashUtils.Fragment, null, /* @__PURE__ */ DashUtils.createElement("baseURL", null, info.base_url), /* @__PURE__ */ DashUtils.createElement("segmentBase", { indexRange: `${info.index_range.start}-${info.index_range.end}` }, /* @__PURE__ */ DashUtils.createElement("initialization", { range: `${info.init_range.start}-${info.init_range.end}` })));
}
...
async function DashManifest({
  ...
  return /* @__PURE__ */ DashUtils.createElement(
    ...
    /* @__PURE__ */ DashUtils.createElement("period", null, audio_sets.map((set, index) => /* @__PURE__ */ DashUtils.createElement(
      "adaptationSet",
      {
        id: index,
      ...
      set.drm_families && set.drm_families.map((drm_family) => /* @__PURE__ */ DashUtils.createElement("contentProtection", { schemeIdUri: `urn:uuid:${getDrmSystemId(drm_family)}` })),
      set.track_roles && set.track_roles.map((role) => /* @__PURE__ */ DashUtils.createElement(
        "role",
        {
      ...
      set.track_name && /* @__PURE__ */ DashUtils.createElement("label", { id: index }, set.track_name),
      set.channels && /* @__PURE__ */ DashUtils.createElement(
      ...
      set.representations.map((rep) => /* @__PURE__ */ DashUtils.createElement(
        "representation",
        {
          id: rep.uid,
        ...
        rep.channels && /* @__PURE__ */ DashUtils.createElement(
          "audioChannelConfiguration",
          {
            schemeIdUri: "urn:mpeg:dash:23003:3:audio_channel_configuration:2011",
            value: rep.channels
        ...
        /* @__PURE__ */ DashUtils.createElement(SegmentInfo, { info: rep.segment_info })
      ))
    )), video_sets.map((set, index) => /* @__PURE__ */ DashUtils.createElement(
      "adaptationSet",
      {
      ...
      set.drm_families && set.drm_families.map((drm_family) => /* @__PURE__ */ DashUtils.createElement("contentProtection", { schemeIdUri: `urn:uuid:${getDrmSystemId(drm_family)}` })),
      set.color_info.primaries && /* @__PURE__ */ DashUtils.createElement(
      ...
      set.color_info.transfer_characteristics && /* @__PURE__ */ DashUtils.createElement(
        "supplementalProperty",
        {
      ...
      set.color_info.matrix_coefficients && /* @__PURE__ */ DashUtils.createElement(
        "supplementalProperty",
        {
      ...
      return /* @__PURE__ */ DashUtils.createElement(
        ...
        set.representations.map(async (rep) => /* @__PURE__ */ DashUtils.createElement(
          "representation",
          {
          ...
          /* @__PURE__ */ DashUtils.createElement(
            "essentialProperty",
            {
      ...
      return /* @__PURE__ */ DashUtils.createElement(
        ...
        set.track_roles.map((role) => /* @__PURE__ */ DashUtils.createElement(
          "role",
          {
            schemeIdUri: "urn:mpeg:dash:role:2011",
            value: role
        ...
        /* @__PURE__ */ DashUtils.createElement("label", { id: index + audio_sets.length }, set.track_name),
        /* @__PURE__ */ DashUtils.createElement(
          "representation",
          {
